    ...
    <div id="events-create-container" class="col-md-6 offset-md-3">
        ...
        <form action="{{ route('update', ['id' => $event->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img class="image-preview" src="/img/events/{{ $event->image }}" alt="{{ $event->title }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input id="date" name="date" type="date" class="form-control" value="{{ date('Y-m-d', strtotime($event->date)) }}">
            </div>
            <div class="form-group">
